...
| $resource_name | Name of the resource involved in the activity. |
| $parent_resource_name | Name of the parent resource associated with the resource. |
| $parent_resource_id | Unique identifier of the parent resource associated with the resource. |
| $parent_resource_type | Type of the parent resource associated with the resource. |
...
The **Edge Applications** data source provides the data from requests made to your [edge applications](/en/documentation/products/build/edge-application/) at Azion. The following variables are available for this option:
...
:::note
You can add the `$traceback` variable when using a custom template for the Edge Applications data source if you have the *Debug rules* option activated in your application. See more on [Debugging rules on Edge Application](/en/documentation/products/build/edge-application/rules-engine/#debugging-rules).
:::
...
The **Edge Functions** data source provides the data from requests made to your [edge functions](/en/documentation/products/build/edge-application/edge-functions/) at Azion.
